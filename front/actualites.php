...
<html >
    ...
    <head>
        <title>OPEN SOPRA STERIA | Actualités</title>
        <meta charset="utf-8">
...
<figure class="actu">
  ...
  <figcaption>
    ...
    <p>Un chiffre symbolique. Et qui laisse supposer une histoire déjà riche ! Et oui : qui dit cinquième édition de l’Open Sopra Steria de Lyon en 2020, dit aussi quatre éditions précédentes pleines de belles choses et de grandes émotions.</p><a href="#" class="Lire">En savoir plus</a>
  </figcaption>
</figure>
...
<figure class="actu"><img src="../images/actu2.png" alt="actu2" />
  ...
  <figcaption>
    ...
    <p>Qui dit « nouvelle édition », dit forcément… « nouvelle affiche » et… « nouveau planning » ! <br> Découvrez dès à présent la planification de vos matchs et réservez vos places !  </p><a href="#" class="Lire">En savoir plus</a>
  </figcaption>
</figure>
...
<figure class="actu"><img src="../images/actu3.jpg" alt="actu3" />
  ...
  <figcaption>
    ...
    <p>Corentin Moutet remporte l’Open Sopra Steria 2019 ! Lui qui avait été éliminé au premier tour les deux années passées a dominé Elias Ymer en finale : 6-4 6-4, en 1h50 ! <br> Revivez ce match de folie !</p><a href="#" class="Lire">En savoir plus</a>
  </figcaption>
</figure>
